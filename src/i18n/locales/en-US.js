...
export default {
  ...
  overlays: {
    ...
    adventurePush:
      'Voke sends notifications when your friends join and interact with the adventures you share, but first we need your permission.',
  },
  profile: {
  ...
  adventuresTab: {
    ...
    dontHaveOne: "I Don't Have One",
    welcomeToAdventures:
      'Welcome {{name}}! This is where you will find all of your adventures with your friends.',
