...
const App = () => {
  ...
  useEffect(() => {
    if (deeplink) {
      /* Alert.alert(deeplink); */
      // TODO: extract campaing params and send them to backend API or Analytics.
      // "https://voke.page.link/?link=https://www.vokeapp.com/govoke/&apn=org.cru.voke&isi=1056168356&ibi=org.cru.voke
      // &utm_campaign=campaign_name_ex
      // &utm_medium=campaign_medium_ex
      // &utm_source=campaing_source_ex
      // &at=affiliate_token_ex
      // &ct=campaign_text_ex
      // &mt=media_type_ex
      // &pt=apple_provider_id_ex"
    }
  }, [deeplink]);
